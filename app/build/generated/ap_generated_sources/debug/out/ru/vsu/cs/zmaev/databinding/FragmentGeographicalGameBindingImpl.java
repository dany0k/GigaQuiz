...
public class FragmentGeographicalGameBindingImpl extends FragmentGeographicalGameBinding  {
    ...
    public FragmentGeographicalGameBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 10, sIncludes, sViewsWithIds));
    }
    private FragmentGeographicalGameBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.game == variableId) {
            setGame((ru.vsu.cs.zmaev.GeographicalGameFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setGame(@Nullable ru.vsu.cs.zmaev.GeographicalGameFragment Game) {
        this.mGame = Game;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
